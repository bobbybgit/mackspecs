class StylesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @style.save
        format.html { redirect_to style_url(@style), data:{:turbo_frame => "content"}, notice: "Style was successfully created." }
  ...
  private
    ...
    def style_params
      params.require(:style).permit(:name, :style_num, :style_image)
    end
end

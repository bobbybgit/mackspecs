...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference("Piece.count") do
      post pieces_url, params: { piece: { area: @piece.area, image: @piece.image, name: @piece.name, sub_area: @piece.sub_area } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { area: @piece.area, image: @piece.image, name: @piece.name, sub_area: @piece.sub_area } }

...
class SpecsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spec" do
    assert_difference("Spec.count") do
      post specs_url, params: { spec: { last_edited: @spec.last_edited, last_exported: @spec.last_exported, last_printed: @spec.last_printed, style_id: @spec.style_id, user_id: @spec.user_id } }
    end
  ...
  test "should update spec" do
    patch spec_url(@spec), params: { spec: { last_edited: @spec.last_edited, last_exported: @spec.last_exported, last_printed: @spec.last_printed, style_id: @spec.style_id, user_id: @spec.user_id } }

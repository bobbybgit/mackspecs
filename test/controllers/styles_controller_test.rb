...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference("Style.count") do
      post styles_url, params: { style: { name: @style.name, style_image: @style.style_image, style_num: @style.style_num } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { name: @style.name, style_image: @style.style_image, style_num: @style.style_num } }
